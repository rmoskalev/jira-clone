...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-md font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
        ...
        [TaskStatus.TODO]: 'border-transparent bg-red-200 text-primary hover:bg-red-400/80',
